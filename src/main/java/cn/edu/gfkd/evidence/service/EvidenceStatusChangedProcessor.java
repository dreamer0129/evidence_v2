...
public class EvidenceStatusChangedProcessor implements BlockchainEventProcessor {
    ...
    public void processEvent(BlockchainEvent event) throws EventProcessingException {
        log.debug("Processing EvidenceStatusChanged event: id={}, txHash={}", 
    ...
    public boolean canProcess(BlockchainEvent event) {
        return "EvidenceStatusChanged".equals(event.getEventName());
    }
     ...
     * 解析事件数据
     */
    private EvidenceStatusChangedEventData parseEventData(BlockchainEvent event) throws IOException {
        try {
            ...
            return new EvidenceStatusChangedEventData(evidenceId, oldStatus, newStatus, user, event.getTransactionHash());
    ...
    private static class EvidenceStatusChangedEventData {
        ...
        EvidenceStatusChangedEventData(String evidenceId, String oldStatus, String newStatus, String user, String transactionHash) {
