...
class EvidenceSyncServiceIntegrationTest {
    ...
    void cleanupOldEvents_InsufficientBlocks_DoesNothing() {
        ...
        // Create blockchain event with low block number
        BlockchainEvent blockchainEvent = new BlockchainEvent(contractAddress, "EvidenceSubmitted",
        ...
        // Create evidence with low block number
        EvidenceEntity evidence = new EvidenceEntity(evidenceId, userAddress, "test_file.pdf",
                "application/pdf", 1024L, BigInteger.valueOf(1234567890), "SHA256", hashValue,
                BigInteger.valueOf(200), transactionHash, BigInteger.valueOf(1234567890),
                "Test evidence memo");
    ...
    void cleanupOldEvents_DeletesEventsBeforeCutoffBlock() {
        ...
        BlockchainEvent oldEvent = new BlockchainEvent(contractAddress, "EvidenceSubmitted",
                BigInteger.valueOf(500), oldTransactionHash, BigInteger.valueOf(1234567890),
                "{\"test\":\"data\"}");
        ...
        BlockchainEvent recentEvent = new BlockchainEvent(contractAddress, "EvidenceSubmitted",
                BigInteger.valueOf(1500), recentTransactionHash, BigInteger.valueOf(1234567890),
                "{\"test\":\"data\"}");
        ...
        EvidenceEntity evidence = new EvidenceEntity(evidenceId, userAddress, "test_file.pdf",
                "application/pdf", 1024L, BigInteger.valueOf(1234567890), "SHA256", hashValue,
                BigInteger.valueOf(2500), transactionHash, BigInteger.valueOf(1234567890),
                "Test evidence memo");
        evidenceRepository.save(evidence);
